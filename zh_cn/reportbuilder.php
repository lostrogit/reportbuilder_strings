...
/**
 * Strings for component 'reportbuilder', language 'zh_cn', version '4.0'.
 *
...
$string['conditions_help'] = '查看此报表时始终适用的默认条件字段表。';
...
$string['filters'] = '过滤器';
$string['filters_help'] = '非自动应用但可供用户使用的过滤器列表。';
